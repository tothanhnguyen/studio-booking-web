...
export default async function AdminSchedulePage() {
  ...
  return <section><h1 className="text-3xl font-semibold">Lịch studio</h1><p className="mt-3 mb-7 text-[var(--color-text-muted)]">Thiết lập giờ mở cửa và các khoảng tạm ngưng theo giờ Việt Nam.</p><ScheduleEditor rooms={rooms} /></section>;
}
